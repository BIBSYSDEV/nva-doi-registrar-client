...
class FindableDoiHandlerTest extends TestBase {
  ...
  void setUp(WireMockRuntimeInfo wireMockRuntimeInfo) {
    ...
    handler =
        new FindableDoiHandler(
            doiClient,
            new DataCiteMetadataResolver(WiremockHttpClient.create()),
            new Environment());
  }
  ...
  void shouldReturnFindableDoi() throws IOException, ClientException {
    ...
    assertThat(
        expectedDoi.getUri(), is(equalTo(response.getBodyObject(DoiResponse.class).getDoi())));
  }
