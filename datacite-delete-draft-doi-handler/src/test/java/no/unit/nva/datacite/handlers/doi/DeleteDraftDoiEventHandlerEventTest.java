...
import static no.unit.nva.datacite.handlers.doi.DeleteDraftDoiEventHandler.ERROR_DELETING_DRAFT_DOI;
import static no.unit.nva.datacite.handlers.doi.DeleteDraftDoiEventHandler.ERROR_GETTING_DOI_STATE;
import static no.unit.nva.datacite.handlers.doi.DeleteDraftDoiEventHandler.EXPECTED_EVENT_WITH_DOI;
import static no.unit.nva.datacite.handlers.doi.DeleteDraftDoiEventHandler.NOT_DRAFT_DOI_ERROR;
import static no.unit.nva.datacite.handlers.doi.DeleteDraftDoiEventHandler.PUBLICATION_HAS_NO_PUBLISHER;
...
public class DeleteDraftDoiEventHandlerEventTest {
    ...
    void shouldDeleteDoiIfDoiIsInDraftState() throws IOException, ClientException {
        ...
        var handler = new DeleteDraftDoiEventHandler(doiClient);
