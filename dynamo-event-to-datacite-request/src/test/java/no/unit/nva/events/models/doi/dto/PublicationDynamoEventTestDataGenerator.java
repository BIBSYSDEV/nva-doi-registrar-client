...
import no.unit.nva.events.models.doi.dto.PublicationStreamRecordTestDataGenerator.Builder;
import nva.commons.utils.JsonUtils;

public class PublicationDynamoEventTestDataGenerator {

    public static final ObjectMapper objectMapper = JsonUtils.objectMapper;
    private final ArrayList<PublicationStreamRecordTestDataGenerator> records;
