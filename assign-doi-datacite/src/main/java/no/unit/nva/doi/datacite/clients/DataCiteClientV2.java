...
public class DataCiteClientV2 implements DoiClient {
  ...
  public DataCiteClientV2() {
    this(
        new CustomerConfigExtractorImpl(
            new Environment().readEnv("CUSTOMER_SECRETS_SECRET_NAME"),
  ...
  public DataCiteClientV2(
      ...
      String doiHost) {
    this.mdsClient = new MdsClient(dataciteMdsUri, customerConfigExtractor, httpClient);
    this.dataCiteRestApiClient =
        new DataCiteRestApiClient(dataciteRestApiUri, doiHost, customerConfigExtractor, httpClient);
  }
