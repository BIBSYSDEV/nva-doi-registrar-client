...
public class CustomerConfigExtractorImpl implements CustomerConfigExtractor {
  ...
  @JacocoGenerated
  public CustomerConfigExtractorImpl(String secretName, String secretKey) {
    this(new SecretsReader(), secretName, secretKey);
  }

  public CustomerConfigExtractorImpl(
      SecretsReader secretsReader, String secretName, String secretKey) {
  ...
  @Override
  public CustomerConfig getCustomerConfig(final Doi doi) throws CustomerConfigException {
  ...
  private void readCustomerConfigFromSecretsReaderIfCustomerConfigsIsEmpty()
  ...
  private CustomerConfig[] convertCustomerConfigStringToDto(String customerConfigsString)
    ...
    return attempt(
            () ->
                JsonUtils.dtoObjectMapper.readValue(customerConfigsString, CustomerConfig[].class))
        .orElseThrow(fail -> new CustomerConfigException(fail.getException()));
  }
