...
/**
 * Class for exchanging data with DataCite when requesting a draft DOI. The data-structure defined
 * here is used by both request and response to the POST /doi method.
 */
public class DraftDoiDto {
   ...
   */
  public Doi toDoi() {
    return Doi.fromDoiIdentifier(this.getDoi());
  }
